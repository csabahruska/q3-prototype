...
getUByte    = getWord8 :: Get Word8
getUByte2   = (,) <$> getWord8 <*> getWord8 :: Get (Word8,Word8)
getUByte3   = (,,) <$> getWord8 <*> getWord8 <*> getWord8 :: Get (Word8,Word8,Word8)
...
readBSP dat = BSPLevel
  ...
  where
    ...
    fromRight (Right a) = a
    el = fromRight $ runGetLazy getHeader dat
    lump g i = fromRight $ runGetLazy (let (o,l) = el !! i in skip o >> g l) dat
